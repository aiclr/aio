...
// This is a comment(注释), and is ignored by the compiler
// You can test this code by clicking the "Run" button over there ->
// or if you prefer to use your keyboard, you can use the "Ctrl + Enter" shortcut

// This code is editable, feel free to hack it!
// You can always return to the original(起初的) code by clicking the "Reset" button ->
...
fn main(){
    ...
    // TODO ^ Try uncommenting this line https://doc.rust-lang.org/stable/rust-by-example/custom_types/structs.html
