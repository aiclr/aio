...
public class College implements Callable<Boolean> {

  private CountDownLatch begin;
  private CountDownLatch end;
  private PurchaseRequest purchaseRequest;

  public College(CountDownLatch begin, CountDownLatch end, PurchaseRequest purchaseRequest) {
    this.begin = begin;
    this.end = end;
  ...
  public Boolean call() throws Exception {
    Thread.currentThread().setUncaughtExceptionHandler(new AsyncExceptionHandler<College>());
    begin.await();
