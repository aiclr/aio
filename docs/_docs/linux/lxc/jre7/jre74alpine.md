<div style="text-align: center;font-size: 40px;">server-jre7u60 for alpine3.15</div>
...
```shell
curl -L -C - -b "oraclelicense=accept-securebackup-cookie" https://download.oracle.com/otn-pub/java/jce/7/UnlimitedJCEPolicyJDK7.zip -o jce_policy-8.zip
```
