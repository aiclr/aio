...
目录结构
 ...
 扩展模块类
 extension/TempExtension.groovy
 extension/TempStaticExtension.groovy

 在 groovy/org/bougainvilleas/ilg/study/chapter07/weather 路径下执行 groovyc 编译 会创建 classes 字节码文件夹
 groovyc -d classes extension/*.groovy
 在 groovy/org/bougainvilleas/ilg/study/chapter07/weather 路径下打包 会创建 weatherExtensions.jar
 jar -cf weatherExtensions.jar -C classes org -C manifest .
 在 groovy/org/bougainvilleas/ilg/study/chapter07/weather 路径下执行测试脚本
 groovy -classpath weatherExtensions.jar FindWeatherTemp.groovy
 *
 */
