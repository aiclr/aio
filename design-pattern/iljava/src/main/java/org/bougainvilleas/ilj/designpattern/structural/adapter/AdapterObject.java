...
/**
 * 对象适配器 将被适配者{@link Volatage220v}转换产品实际需求的规格 - 5V{@link Volatage5V}
 */
public class AdapterObject implements Volatage5V {

  private static final Logger log = Logger.getLogger(AdapterObject.class.getSimpleName());

  private Volatage220v source;
