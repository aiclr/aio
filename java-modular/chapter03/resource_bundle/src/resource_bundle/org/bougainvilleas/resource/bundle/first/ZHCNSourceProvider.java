...
public class ZHCNSourceProvider extends AbstractResourceBundleProvider implements SourceProvider
{

    //source_zh_CN.properties
//    private static Locale DUTCH = Locale.forLanguageTag("zh-CN");
    private static Locale DUTCH = Locale.CHINA;
